				...
				<tr>
					...
					<td>
						<div class="input-group align-items-center">
							...
							&nbsp;@&nbsp;
							<input type="text" name="mail1" value="<%=mail[1]%>" class="form-control"/>
						</div>
					</td>
				</tr>
      	...
      	<div class="d-flex justify-content-end">
      		<div class="btn-group">
      			<input type="button" value="목록" class="btn btn-primary" onclick="location.href='board_list.jsp?cpage=<%=cpage%>'">
   				<input type="button" value="보기" class="btn btn-secondary" onclick="location.href='board_view.jsp?cpage=<%=cpage%>&seq=<%=seq%>'">
   				<input type="button" id="submit1" value="수정" class="btn btn-danger">
      		</div>
      	</div>
